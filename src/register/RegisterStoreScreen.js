...
export default class RegisterStoreScreen extends Component {
  ...
  doRegister = () => {
    ...
    if (this.doValidate()) {
      ...
      fetch('https://newsupply.networkgateway.net:8500/user/register', {
        method: 'POST',
        headers: {
        ...
        .then((data) => {
          ...
          if (code === 100) {
            ...
            this.setState({
              ...
              registerResult: "Error: Failed to add object with ID " + this.state.id.value ,
              id: {
                ...this.state.id,
                error: "Error: Failed to add object with ID " + this.state.id.value,
              }
            });  // 失败
          }
        }
